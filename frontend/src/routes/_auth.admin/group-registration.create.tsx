...
function RouteComponent() {
  ...
  const canCreate = name.trim().length > 0 && slots.length > 0 && !createMutation.isPending
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-lg font-semibold text-gray-900 m-0">New registration group</h2>
      </div>
