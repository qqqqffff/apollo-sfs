          ...
          {link_provider && link_email ? (
            ...
            <>
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <a
                  href={socialLoginUrl('apple')}
                  className="flex items-center justify-center gap-2.5 px-4 py-2 rounded-lg border border-gray-900 bg-gray-900 hover:bg-gray-800 text-sm font-medium text-white transition-colors no-underline"
                >
