...
const ALICE = { username: 'alice', email: 'alice@example.com', is_admin: false, is_premium: false, premium_granted_at: null, premium_subscribed: false, storage_used_bytes: 0, storage_quota_bytes: 0, created_at: '', last_seen_at: null, linked_providers: [], sandbox_payments_enabled: false, expansion_override_enabled: false, feedback_access_enabled: false }
