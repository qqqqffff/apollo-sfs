...
const FOLDER: Folder = { id: 'fold-1', user_id: 'u1', name: 'Docs', kind: 'regular', size_bytes: 0, drive_id: null, created_at: '', updated_at: '', parent_id: null }
const TARGET_FOLDER: Folder = { id: 'fold-target', user_id: 'u1', name: 'Target', kind: 'regular', size_bytes: 0, drive_id: null, created_at: '', updated_at: '', parent_id: null }
