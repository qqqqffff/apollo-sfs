// Single source of truth for the password rules shown in the app. These mirror
...
// inline checklist. Keep this, the web copy (frontend/src/utils/passwordPolicy.ts)
// and the realm policy in sync.
